    ...
    return {
        init: function () {
            ...
            $cubeList.tap(function () {
                ...
                //跳转详情，通过传递点击Li的索引，让其定位到具体的slide
...
let detailRender = (function () {
    ...
    return {
        init: function (index = 0) {
            ...
            swiper.slideTo(index, 0);//跳转到具体的slide页面
        }
    }
})();
